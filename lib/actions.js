...
export function getCountries() {
    return(dispatch)=>{
        return axios.get(process.env.NEXT_PUBLIC_URL + '/api/getListOfCountries')
        .then(data=>{console.log(data.data, 'action'); dispatch({type:"ADD_COUNTRIES", payload:data.data})})
    }
}